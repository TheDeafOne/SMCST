...
//
//def humanMove(gameBoard: State): Int  = {
//    getIntegerInput
//}
//
//def randomMove(gameBoard: State): Int  = {
...
// */
//def greedyTTTMove(heuristic: TicTacToeBoard => Int = getScoringTTTBHeuristic)(gameBoard: Game): Int = {
...
//}
//
//def parallelGreedyTTTMove(heuristic: TicTacToeBoard => Int = getScoringTTTBHeuristic)(gameBoard: Game): Int = {
//    if (!gameBoard.isInstanceOf[TicTacToeBoard]) {
//        return -1
//    }
//
...
// */
//def minimaxTTTMove(depth: Int, heuristic: TicTacToeBoard => Int = getScoringTTTBHeuristic)(gameBoard: Game): Int = {
//    if (!gameBoard.isInstanceOf[TicTacToeBoard]) {
//        return -1
//    }
//    val playerCoeff = if (gameBoard.getNextPlayer) then 1 else -1
...
//}
//
//def parallelMinimaxTTTMove(depth: Int, heuristic: TicTacToeBoard => Int = getScoringTTTBHeuristic)(gameBoard: Game): Int = {
//    if (!gameBoard.isInstanceOf[TicTacToeBoard]) {
//        return -1
//    }
//    val playerCoeff = if (gameBoard.getNextPlayer) then 1 else -1
